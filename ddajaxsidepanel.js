...
var ddajaxsidepanel = {
	defaults: {ajaxloadgif:'squareloading.gif', fx:{dur:'normal', easing:'swing'}, openamount:'90%', openamount_minthreshold:'400px'},
...
jQuery(function(){
	ddajaxsidepanel.init({
		targetselector: 'a[rel="sideframe"]',
		ajaxloadgif: 'images/squareloading.gif', //full path to "loading" gif relative to document. When in doubt use absolute URL to image.
		fx: {dur:500, easing: 'easeInQuad'}, // dur: duration of slide effect (milliseconds), easing: 'ease_in_type_string'
		openamount:'75%', // Width of panel when fully opened (Percentage value relative to page, or pixel value
